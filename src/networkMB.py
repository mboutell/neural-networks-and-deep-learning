...
def main():
    ...
    net = Network([784, 30, 10])    # Single hidden layer with 30 neurons.
    # TODO: also change to net = Network([784, 10]) # What acc do we get? 84.12% on epoch 27. Not bad!
    net.SGD(training_data, epochs=30, mini_batch_size=10, eta=3.0, validation_data=validation_data)

main()
# On first run, gives max val acc of 95.57% on epoch 26